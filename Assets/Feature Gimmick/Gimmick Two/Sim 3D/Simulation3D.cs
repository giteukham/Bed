...
public class Simulation3D : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        tests = new Vector3[numParticles];
        ...
        test = ComputeHelper.CreateStructuredBuffer<float3>(numParticles);
        ...
        ComputeHelper.SetBuffer(compute, test, "Test", externalForcesKernel, spatialHashKernel, densityKernel, pressureKernel, viscosityKernel, updatePositionsKernel);
