...
//     
//     private Dictionary<ResizeType, InsideSideResize> resizeEvents = new Dictionary<ResizeType, InsideSideResize>();
...
//             }
//             
//             InsideSideResize insideSideResize = CreateResizeEvent(resizeBound, type);
//             
//             if (resizeBound != null)
//             {
//                 this.resizeEvents.TryAdd(type, insideSideResize);
//             }
//         }
//     }
//     
//     private InsideSideResize CreateResizeEvent(GameObject resizeBound, ResizeType type)
//     {
//         InsideSideResize insideSideResize = resizeBound.AddComponent<InsideSideResize>();
//         insideSideResize.ResizeType = type;
//
//         return insideSideResize;
//     }
//
