...
public class ResolutionInside : MonoBehaviour//, IDragHandler, IPointerClickHandler
{
    ...
    // private void Awake()
    // {
    //     insideRect = GetComponent<RectTransform>();
    //     
    ...
    // }
    //
    // private InsideBoundaryResize CreateResizeEvent(GameObject resizeBound, ResizeType type)
    // {
    //     InsideBoundaryResize insideBoundaryResize = resizeBound.AddComponent<InsideBoundaryResize>();
    //     insideBoundaryResize.ResizeType = type;
    //
    //     return insideBoundaryResize;
    // }
    //
