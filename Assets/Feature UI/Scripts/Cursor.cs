        ...
        public static void SetCursor(CursorType cursorType)
        {
            switch (cursorType)
            {
                ...
                case CursorType.DiagonalResize1:
                    UnityEngine.Cursor.SetCursor(instance.diagonalResize1, new Vector2(16, 16), CursorMode.Auto);
                    break;
                case CursorType.DiagonalResize2:
                    UnityEngine.Cursor.SetCursor(instance.diagonalResize2, new Vector2(16, 16), CursorMode.Auto);
                    break;
                case CursorType.HorizontalResize:
                    UnityEngine.Cursor.SetCursor(instance.horizontalResize, new Vector2(16, 16), CursorMode.Auto);
                    break;
                case CursorType.VerticalResize:
                    UnityEngine.Cursor.SetCursor(instance.verticalResize, new Vector2(16, 16), CursorMode.Auto);
                    break;
                default:
